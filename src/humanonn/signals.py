...
SIGNALS: list[SignalDefinition] = [
    ...
    signal("tier2_spare", 2, "Reserved Tier 2 signal slot", "ambiguous", "origin", "Review manually once this signal is defined."),
    ...
    signal("stock_images", 4, "Images appear to be Unsplash stock photos", "ambiguous", "polish", "Use original product, team, or customer imagery."),
    ...
    signal("weak_contrast_feel", 4, "Contrast passes but feels wrong", "ambiguous", "polish", "Tune perceived contrast and surface hierarchy."),
